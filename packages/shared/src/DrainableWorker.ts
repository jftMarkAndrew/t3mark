 ...
 *
 * Wraps the common `Queue.unbounded` + `Effect.forever` pattern and tracks
 * outstanding work explicitly so tests can wait deterministically for the
 * worker to become idle.
 *
