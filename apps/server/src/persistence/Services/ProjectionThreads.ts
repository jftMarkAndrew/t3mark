...
export const ProjectionThread = Schema.Struct({
  ...
  devServerPort: Schema.NullOr(Schema.Int),
  bootstrapStatus: Schema.Literals(["idle", "running", "ready", "failed"]),
  bootstrapCommand: Schema.NullOr(Schema.String),
  bootstrapLastError: Schema.NullOr(Schema.String),
  pendingLocalhostLaunch: Schema.Boolean,
